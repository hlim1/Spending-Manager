...
class ExchangeRatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exchange_rate" do
    assert_difference('ExchangeRate.count') do
      post exchange_rates_url, params: { exchange_rate: { account_id: @exchange_rate.account_id } }
    end
  ...
  test "should update exchange_rate" do
    patch exchange_rate_url(@exchange_rate), params: { exchange_rate: { account_id: @exchange_rate.account_id } }
